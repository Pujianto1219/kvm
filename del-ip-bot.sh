#!/bin/bash
# Token Pujianto1219 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
    TOKEN="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"
    git clone https://github.com/Pujianto1219/ip /root/ipvps/ &> /dev/null
    clear
    echo ""
    ...
    git push -f https://${TOKEN}@github.com/Pujianto1219/permission.git &> /dev/null
    rm -rf /root/ipvps
    clear
    sleep 1

...
# Memproses Info Limit LEBIH AWAL agar bisa dimasukkan ke dalam HTML
...
# Pembuatan File HTML untuk Web View
cat > /home/vps/public_html/ssh-$Login.html <<EOF
<!DOCTYPE html>
<html lang="id">
<head>
    <meta charset="UTF-8">
    ...
    <style>
        body { background-color: #171b26; color: #9ba1b4; font-family: 'Segoe UI', Tahoma, Geneva, Verdana, sans-serif; display: flex; justify-content: center; padding: 20px; margin: 0; }
        .container { background-color: #212634; border-radius: 12px; width: 100%; max-width: 400px; padding: 25px; box-shadow: 0 10px 15px -3px rgba(0, 0, 0, 0.3); }
        .header { display: flex; align-items: center; margin-bottom: 30px; }
        .header-icon { background-color: #1b4933; color: #22c55e; width: 50px; height: 50px; border-radius: 50%; display: flex; align-items: center; justify-content: center; font-size: 24px; margin-right: 15px; }
        .header-text h2 { margin: 0; color: #ffffff; font-size: 18px; }
        .header-text p { margin: 5px 0 0; font-size: 13px; }
        .section-title { display: flex; align-items: center; color: #ffffff; font-size: 16px; font-weight: 600; margin: 25px 0 15px; }
        .section-title i { margin-right: 10px; }
        .text-green { color: #22c55e; }
        .text-purple { color: #c084fc; }
        .row { display: flex; justify-content: space-between; align-items: center; padding: 12px 0; border-bottom: 1px solid #2d3345; font-size: 14px; }
        ...
        .pubkey-container { display: flex; align-items: center; background-color: #2d3345; padding: 8px; border-radius: 8px; border: 1px solid #3f4760; }
        .pubkey-text { font-family: monospace; font-size: 11px; color: #e2e8f0; max-width: 150px; overflow: hidden; text-overflow: ellipsis; white-space: nowrap; }
        .btn-copy { background-color: #3b82f6; color: white; border: none; border-radius: 6px; padding: 8px 12px; margin-left: 10px; cursor: pointer; font-size: 14px; }

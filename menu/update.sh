...
wget -q -O /usr/bin/m-rebuild "https://raw.githubusercontent.com/Pujianto1219/kvm/main/menu/m-rebuild.sh" && chmod +x /usr/bin/m-rebuild
wget -q -O /usr/bin/add-ip-bot "https://raw.githubusercontent.com/Pujianto1219/kvm/main/bot/add-ip-bot.sh" && chmod +x /usr/bin/add-ip-bot
...
wget -q -O /usr/bin/ex.sh "https://raw.githubusercontent.com/Pujianto1219/kvm/main/ex.sh" && chmod +x /usr/bin/ex.sh

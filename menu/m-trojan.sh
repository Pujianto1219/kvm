...
until [[ $iplim =~ ^[0-9]+$ ]]; do
read -p "  Limit IP (0=Unli) : " iplim
done

until [[ $Quota =~ ^[0-9]+$ ]]; do
read -p "  Limit GB (0=Unli) : " Quota
done
...
# Pengkondisian Limit IP & Quota untuk Info & Database
...
# ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
# FORMAT NOTIFIKASI TELEGRAM 1 (INFO AKUN)
# ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
TEXT="
🧿───────────────────🧿            
        ✨PREMIUM TROJAN✨
...
│Path NTLS  : <code>/trojan-ntls</code>
...
# ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
# FORMAT NOTIFIKASI TELEGRAM 2 (INFO TRANSAKSI ADMIN)
# ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
...
echo -e "$COLOR1 ${NC} ${WH}Limit IP     ${COLOR1}: ${WH}${info_ip}" | tee -a /etc/trojan/akun/log-create-${user}.log
echo -e "$COLOR1 ${NC} ${WH}Limit Quota  ${COLOR1}: ${WH}${info_quota}" | tee -a /etc/trojan/akun/log-create-${user}.log
...
# Akan menghapus config Trojan Xray, File IP, File Quota, File Txt, lalu Restart Xray
# ==========================================
echo "sed -i '/^#tr $user $exp $uuid/,/^},{/d' /etc/xray/config.json && sed -i '/^#trg $user $exp/,/^},{/d' /etc/xray/config.json && rm -f /etc/trojan/${user}IP && rm -f /etc/trojan/${user} && rm -f /home/vps/public_html/trojan-${user}.txt && systemctl restart xray" | at now + $timer minutes &> /dev/null
# ==========================================
...
echo -e "$COLOR1 ${NC} ${WH}Limit Quota  ${COLOR1}: ${WH}${Quota} GB" | tee -a /etc/trojan/akun/log-create-${user}.log
echo -e "$COLOR1 ${NC} ${WH}Expired In   ${COLOR1}: ${WH}$timer Minutes" | tee -a /etc/trojan/akun/log-create-${user}.log
echo -e "$COLOR1 ◇━━━━━━━━━━━━━━━━━◇ ${NC}" | tee -a /etc/trojan/akun/log-create-${user}.log
echo -e "$COLOR1 ${NC} ${WH}Port TLS     ${COLOR1}: ${WH}443" | tee -a /etc/trojan/akun/log-create-${user}.log
echo -e "$COLOR1 ${NC} ${WH}Port gRPC    ${COLOR1}: ${WH}443" | tee -a /etc/trojan/akun/log-create-${user}.log
echo -e "$COLOR1 ${NC} ${WH}UUID         ${COLOR1}: ${WH}${uuid}" | tee -a /etc/trojan/akun/log-create-${user}.log
...
echo -e "$COLOR1 ${NC} ${WH}Path gRPC    ${COLOR1}: ${WH}trojan-grpc" | tee -a /etc/trojan/akun/log-create-${user}.log
echo -e "$COLOR1 ◇━━━━━━━━━━━━━━━━━◇ ${NC}" | tee -a /etc/trojan/akun/log-create-${user}.log
echo -e "$COLOR1 ${NC} ${WH}Link WS      ${COLOR1}: " | tee -a /etc/trojan/akun/log-create-${user}.log
echo -e "$COLOR1 ${NC} ${WH}${trojanlink}" | tee -a /etc/trojan/akun/log-create-${user}.log
echo -e "$COLOR1 ◇━━━━━━━━━━━━━━━━━◇ ${NC}" | tee -a /etc/trojan/akun/log-create-${user}.log
echo -e "$COLOR1 ${NC} ${WH}Link gRPC    ${COLOR1}: " | tee -a /etc/trojan/akun/log-create-${user}.log
echo -e "$COLOR1 ${NC} ${WH}${trojanlink1}" | tee -a /etc/trojan/akun/log-create-${user}.log

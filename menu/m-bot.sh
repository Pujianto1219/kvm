...
data_ip="https://raw.githubusercontent.com/usernsme/ip/main/ip"
checking_sc() {
    ...
    if [[ $date_list < $useexp ]]; then
        ...
        echo -e "$COLOR1╭═════════════════════════════════════════════════╮${NC}"
        echo -e "$COLOR1 ${NC} ${COLBG1}          ${WH}• Pujianto1219 PREMIUM •               ${NC} $COLOR1 $NC"
        echo -e "$COLOR1╰═════════════════════════════════════════════════╯${NC}"
        echo -e "$COLOR1╭═════════════════════════════════════════════════╮${NC}"
        ...
        echo -e "     \033[0;36mTelegram${NC}: https:t.me/ wa.me/+628981874211"
        echo -e "$COLOR1╰═════════════════════════════════════════════════╯${NC}"
        exit
    fi
}
...
cd /usr/bin
clear
wget https://raw.githubusercontent.com/Pujianto1219/kvm/main/bot/bot.zip
unzip bot.zip
mv bot/* /usr/bin
chmod +x /usr/bin/*
rm -rf bot.zip
clear
wget https://raw.githubusercontent.com/Pujianto1219/kvm/main/bot/kyt.zip
unzip kyt.zip
...
wget -q -O /usr/bin/addtrgo "https://raw.githubusercontent.com/gazzent/kvm/main/trgo/addtrgo.sh" && chmod +x /usr/bin/addtrgo

wget -q -O /usr/bin/deltrgo "https://raw.githubusercontent.com/gazzent/kvm/main/trgo/deltrgo.sh" && chmod +x /usr/bin/deltrgo

wget -q -O /usr/bin/cektrgo "https://raw.githubusercontent.com/gazzent/kvm/main/trgo/cektrgo.sh" && chmod +x /usr/bin/cektrgo

wget -q -O /usr/bin/renewtrgo "https://raw.githubusercontent.com/gazzent/kvm/main/trgo/renewtrgo.sh" && chmod +x /usr/bin/renewtrgo
...
rm -rf bot.zip
clear
wget https://raw.githubusercontent.com/gazzent/Pujianto1219/main/bot/kyt.zip
unzip kyt.zip
cd kyt
pip3 install -r kyt/requirements.txt
clear

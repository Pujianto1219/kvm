...
rm -rf .git &> /dev/null
git init &> /dev/null
wget https://raw.githubusercontent.com/${USERGIT}/ip/main/ip &> /dev/null
...
sleep 1
REQIP=$(curl -sS https://raw.githubusercontent.com/${USERGIT}/ip/main/ip | awk '{print $4}' | grep $daftar)
...
U6=$(curl -sS https://raw.usercontent.com/Pujianto1219/ip/main/ip | grep $MYIP | awk '{print $6}')
...
nama2=$(curl -sS https://raw.usercontent.com/Pujianto1219/ip/main/ip | grep $MYIP | awk '{print $2}')
...
ip=$(curl -sS https://raw.usercontent.com/Pujianto1219/ip/main/ip | grep $MYIP | awk '{print $6}')
...
<i>Tunggu 5 Menit Untuk Server KeRefresh</i>
<b><i>Terima Kasih Sudah Menggunakan Credits By VPN </i></b>
"'&reply_markup={"inline_keyboard":[[{"text":"CHANNEL","url":"https://t.me/"},{"text":"ORDER AUTOSCRIPT","

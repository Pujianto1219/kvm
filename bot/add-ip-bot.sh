#!/bin/bash
# // PROJECT STORE
url_izin="https://raw.githubusercontent.com/Pujianto1219/admin/main/ip"
...
git clone https://github.com/Pujianto1219/ip.git /root/ipvps/ &> /dev/null
clear
echo -e ""
...
git config --global user.name "Pujianto1219" &> /dev/null
rm -rf .git &> /dev/null
git init &> /dev/null
git add . &> /dev/null
git commit -m register &> /dev/null
git branch -M main &> /dev/null
git remote add origin https://github.com/Pujianto1219/ip
